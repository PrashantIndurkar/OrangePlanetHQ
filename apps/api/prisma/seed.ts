  ...
  const tasks = await prisma.task.createMany({
    data: [
      ...
      },
      {
        ...
        description: "Develop custom JWT signup, login, and token verification routes",
        status: "in-progress",
        priority: "urgent",
      ...
      },
      {
        ...
        description: "Protect REST API routes using authenticated JWT verification middleware",
        status: "todo",
        priority: "medium",
        userId: user.id,
      },
      {
        ...
        description: "Integrate pagination parameters and page selection buttons on the frontend list",
        status: "backlog",
        priority: "low",
        userId: user.id,
      },
